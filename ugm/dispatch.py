...
`docs/overview.md` probed this before any of it was built, and the probe produced two rules that are
...
def register(name: str, handler, *, observes: bool = False) -> None:
    ...
    **⭐ `observes=True` says this tool only LOOKS.** the design notes named the absence of this as a concrete
