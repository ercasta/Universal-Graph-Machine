...
It is NOT an engine skeleton; the real matcher port is Slice 2 of `docs/design/rust_engine_plan.md`.
...
Amdahl: this is the hot-loop constant, not the end-to-end system speedup — see `docs/design/rust_engine_plan.md` §0.
