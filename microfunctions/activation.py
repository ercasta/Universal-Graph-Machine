...
**The gap this closes, stated as the test that makes it checkable** (HANDOFF §6b):
...
one implementation of a step. HANDOFF §6b names keeping a fast Python loop "just for the hot path" as the
