...
* **⭐ The verdict is a fact.** `graph_data_model.md` §6.1 recorded a real gap: a supposition's verdict came
...
def conclude(g: Graph, h: str, verdict: str, *, because=None) -> str:
    """Settle a hypothesis. THE verdict-as-a-fact that `graph_data_model.md` §6.1 found missing."""
