...
This closes the gap `docs/microfunctions/graph_data_model.md` §6.3 named as the single most load-bearing
...
experiment (`units/episode_to_procedure_probe_experiment.py`) found that applications minted in one settle
