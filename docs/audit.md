...
| `driver.VERBS` | expand, decompose, commit, sense, refuse | **no — two are unimplemented** | none stated | ⚠ see F6 |
| `forget.ROOT_KINDS` | 8 node kinds | n/a — it is a policy, not a vocabulary | none | ❌ see F7 |
