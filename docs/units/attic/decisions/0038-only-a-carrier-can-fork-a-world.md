...
**Status — current (2026-07-28): REPLACED.** `../../model.md` §7 — world-forking is not a carrier privilege; a conclusion is inside a hypothesis because the units producing it are powered by it.

**Status — as recorded:** Accepted — amends 0006
