...
**Status — current (2026-07-28): REVERSED.** `../../model.md` §1 — data is the substrate. Partly rehabilitated: units persist and are themselves data, but they are *over* the data, not it.
