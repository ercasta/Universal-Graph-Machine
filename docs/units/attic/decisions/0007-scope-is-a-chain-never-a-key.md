...
**Status — current (2026-07-28): HALF.** `../../model.md` §7 — scope is not a chain *or* a key; it is which configuration powers a conclusion. The intermediate position (a chain plus explicit markers) is also gone.
