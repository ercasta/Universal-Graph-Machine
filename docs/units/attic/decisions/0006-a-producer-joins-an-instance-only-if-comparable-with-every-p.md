...
**Status — current (2026-07-28): REPLACED.** `../../model.md` §7 — scope is support, read off the wiring backwards. Comparability and its carrier-lineage amendment (0038) both go.

**Status — as recorded:** Accepted — **amended by [0038](0038-only-a-carrier-can-fork-a-world.md)**: comparability is judged over CARRIER lineage, because only a carrier forks a world
