...
**Status — current (2026-07-28): SURVIVES, and strengthened.** `../../model.md` §16 — mutation testing found subset output is what makes positioning correct, reversing the carry-forward it was in tension with. The open part is how wide it forces the wiring.
