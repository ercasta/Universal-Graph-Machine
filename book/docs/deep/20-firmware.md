...
Back in Chapter 17 we said ordinary reasoning can only ever *add* facts — there's
...
exactly the promise Chapter 16 made about *Universal*.
...
[Thinking harder →](21-thinking-harder.md)
